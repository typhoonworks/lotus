defmodule Lotus.Sources do
  ...
  """
  @spec source_type(module() | String.t()) :: :postgres | :mysql | :sqlite | :oracle | :tds | :other
  ...
  def source_type(repo) when is_atom(repo) do
    case repo.__adapter__() do
      ...
      Ecto.Adapters.Jamdb.Oracle -> :oracle
  ...
  def supports_feature?(:oracle, :search_path), do: true
  def supports_feature?(:oracle, :make_interval), do: false
  def supports_feature?(:oracle, :arrays), do: false
  def supports_feature?(:oracle, :json), do: false
